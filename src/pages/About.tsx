      ...
      <div className="bg-gradient-to-br from-[#fefefe] to-[#f2f2f2] min-h-screen py-20 px-8 lg:px-32">
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-6">
            ...
            offering everything from everyday basics to bold statement pieces.
            Our collections are thoughtfully curated to reflect quality,
            comfort, and the latest trends.
          </p>
          <p className="text-lg text-gray-700">
            Whether you're shopping for streetwear, accessories, or timeless
            wardrobe staples — we're here to make your fashion experience
            seamless and inspiring. Join thousands of style-savvy shoppers and
